...
4) For testing, run 'LD_LIBRARY_PATH=z3/[z3version]/lib sbt test'.
Alternatively, start a console by running 'LD_LIBRARY_PATH=z3/[z3version]lib
scala -cp target/[scalaversion]scalaz3.jar' then try, e.g.,
