...
public final class Z3Wrapper {
    ...
    private static final String MS_LIB_NAME = "msvcr120d";
    ...
    private static void loadFromJar() {
        ...
        try {
          ...
          if (os != null && os.indexOf("Win") >= 0) {
            // Under windows, we first load libz3 and msvcr120d explicitly, on which ScalaZ3 depends
            debug("Loading " + MS_LIB_NAME);
            System.loadLibrary(MS_LIB_NAME);
